...
<t:layout title="Infinity- Customer Registration">
  ...
  <form method="post" action="CreateCustomerServlet" id="form">
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="phoneNumber" type="text" place name="phoneNumber">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select class="form-control" for="input-lg" id="state" name="state">
